...
namespace Application.Services.CollectionServices
{
    public class CollectionCommandService : ICollectionCommandService
    {
		...
		public async Task DeactivateCollectionsWithoutActiveProductsAsync(int productId)
		{
			...
			try
			{
				var collections = await _unitOfWork.Repository<Domain.Models.Collection>()
					.GetAll()
				...
				{
					_unitOfWork.Repository<Domain.Models.Collection>().UpdateList(collectionsToDeactivate);
        ...
        public async Task<Result<bool>> RemoveProductsFromCollectionAsync(int collectionId, RemoveProductsFromCollectionDto productsDto, string userId)
        {
            ...
            try
            {
                ...
                var collection = await _unitOfWork.Repository<Domain.Models.Collection>()
                            .GetAll()
                ...
                var hasValidProducts = await _unitOfWork.Repository<Domain.Models.Collection>()
                     .GetAll()
