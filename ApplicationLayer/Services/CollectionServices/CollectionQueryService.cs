...
namespace ApplicationLayer.Services.CollectionServices
{
    public class CollectionQueryService : ICollectionQueryService
    {
        ...
        private IQueryable<DomainLayer.Models.Collection> BasicFilter(IQueryable<DomainLayer.Models.Collection> query, bool? IsActive = null, bool? IsDeleted = null, bool IsAdmin = false)
        {
            if (!IsAdmin)
            {
