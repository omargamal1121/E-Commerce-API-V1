    ...
    public class DiscountCommandService : IDiscountCommandService
    {
        ...
        public async Task<Result<DiscountDto>> CreateDiscountAsync(CreateDiscountDto dto, string userId)
        {
            ...
            try
            {
                ...
                var existingDiscount = await _unitOfWork.Repository<Discount>().GetAll().AsNoTracking()
                ...
                var result = await _unitOfWork.Repository<Discount>().CreateAsync(discount);
                if (result == null)
                {
        ...
        public async Task<Result<bool>> DeleteDiscountAsync(int id, string userId)
        {
            ...
            try
            {
                ...
                var result = await _unitOfWork.Repository<Discount>().SoftDeleteAsync(id);
