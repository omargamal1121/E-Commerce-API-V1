...
namespace Application.Services.CategoryServices
{
	public class CategoryQueryService : ICategoryQueryService
	{
		...
		private IQueryable<Domain.Models.Category> BasicFilter(IQueryable<Domain.Models.Category> query, bool? isActive = null, bool? isDeleted = null,bool IsAdmin=false)
		{
			if(!IsAdmin)
