...
namespace Application.Services.CustomerAddressServices
{
    ...
    {
        public CustomerAddressDto ToDto(Domain.Models.CustomerAddress address)
        {
        ...
        public List<CustomerAddressDto> ToDtos(IEnumerable<Domain.Models.CustomerAddress> addresses)
        {
            if (addresses == null) return new List<CustomerAddressDto>();
            return addresses.Select(ToDto).ToList();
        }

        public Domain.Models.CustomerAddress ToEntity(CreateCustomerAddressDto dto, string userId)
        {
        ...
        public void ApplyUpdates(Domain.Models.CustomerAddress entity, UpdateCustomerAddressDto dto)
        {
