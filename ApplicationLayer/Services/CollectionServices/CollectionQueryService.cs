...
namespace Application.Services.CollectionServices
{
    public class CollectionQueryService : ICollectionQueryService
    {
        ...
        private IQueryable<Domain.Models.Collection> BasicFilter(IQueryable<Domain.Models.Collection> query, bool? IsActive = null, bool? IsDeleted = null, bool IsAdmin = false)
        {
            if (!IsAdmin)
            {
