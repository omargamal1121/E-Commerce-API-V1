...
namespace Application.Services.PaymentServices
{
    ...
    lastpayment?.CreatedAt?.AddMinutes(10) <= DateTime.UtcNow)
        ...
        private async Task<Result<PaymentResponseDto>> ProcessOnlinePayment(CreatePaymentOfCustomer paymentdto, Domain.Models.Order order, Payment payment,long providerorderid)
        {
